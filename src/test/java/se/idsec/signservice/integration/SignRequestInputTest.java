...
public class SignRequestInputTest {
  ...
  public void testCompleteJson() throws Exception {
        ...
        .certificateRequirements(SigningCertificateRequirements.builder()
            ...
            .attributeMappings(Arrays.asList(
                CertificateAttributeMapping.builder()
                    .source(SignerIdentityAttribute.createBuilder().type(SignerIdentityAttribute.SAML_TYPE)
                        .name("urn:oid:1.2.752.29.4.13").build())
    ...
    final String json = writer.writeValueAsString(input);

    //    System.out.println(json);

    final SignRequestInput input2 = mapper.readValue(json, SignRequestInput.class);
            ...
            .visiblePdfSignatureRequirement(
                VisiblePdfSignatureRequirement.builder()
                    ...
                    .signerName(SignerName.builder()
                        ...
                        .signerAttribute(
                            SignerIdentityAttribute.createBuilder().name("urn:oid:1.2.752.29.4.13").build())
                        .formatting("%0 %1 (%2)")
                        .build())
