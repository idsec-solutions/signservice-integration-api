...
/**
 * Represents a "null" visible PDF signature requirement. This may be used in cases where the signature policy that is
 ...
 */
public class NullVisiblePdfSignatureRequirement extends VisiblePdfSignatureRequirement {
   ...
   * Constructor.
   */
  public NullVisiblePdfSignatureRequirement() {
    this.addExtensionValue(NULL_INDICATOR_EXTENSION, "true");
  }
